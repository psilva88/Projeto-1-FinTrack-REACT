...
/**
 * Toda query passa por aqui: se não houver usuário no contexto,
 * o acesso é negado. É o equivalente ao middleware de auth do REST.
 */
...
const calcularSaldoPorConta = async (usuarioId) => {
  ...
  // Uma única agregação para todas as contas, em vez de um find por conta
...
const resolvers = {
  // Converte o _id do Mongo para o campo id do GraphQL
  ...
  Query: {
    ...
    resumoMensal: async (_, { mes, ano }, contexto) => {
      ...
      // Primeiro e último instante do mês
